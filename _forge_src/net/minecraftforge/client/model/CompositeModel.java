...
public class CompositeModel implements IUnbakedGeometry<CompositeModel>
{
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation)
    {
        ...
        for (var entry : children.entrySet())
        {
            ...
            bakedPartsBuilder.put(name, model.m_111449_(baker, model, spriteGetter, modelState, modelLocation, true));
        }
    ...
    {
        children.values().forEach(child -> child.m_5500_(modelGetter));
    }
