...
public class StandaloneGeometryBakingContext implements IGeometryBakingContext
{
    ...
    {
        return builder().withTextures(textures, MissingTextureAtlasSprite.m_118071_()).build(modelName);
    }
    ...
    public static final class Builder
    {
        ...
        {
            return withTextures(TextureAtlas.f_118259_, textures, defaultTexture);
        }
