...
public class ForgeEventFactoryClient {
    ...
    public static boolean onMouseScroll(MouseHandler mouseHelper, double deltaX, double deltaY) {
        return post(new InputEvent.MouseScrollingEvent(deltaX, deltaY, mouseHelper.m_91560_(), mouseHelper.m_168090_(), mouseHelper.m_91584_(), mouseHelper.m_91589_(), mouseHelper.m_91594_()));
    }
