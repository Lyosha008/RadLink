...
public interface IForgeBlockState
{
    ...
    {
        return self().m_60734_().getFriction(self(), level, pos, entity);
    }
    ...
    {
        return self().m_60734_().getLightEmission(self(), level, pos);
    }
    ...
    {
        return self().m_60734_().isLadder(self(), level, pos, entity);
    }
    ...
    {
        return self().m_60734_().canHarvestBlock(self(), level, pos, player);
    }
    ...
    {
        return self().m_60734_().onDestroyedByPlayer(self(), level, pos, player, willHarvest, fluid);
    }
    ...
    {
        return self().m_60734_().isBed(self(), level, pos, sleeper);
    }
    ...
    {
        return self().m_60734_().isValidSpawn(self(), level, pos, type, entityType);
    }
    ...
    {
        return self().m_60734_().getRespawnPosition(self(), type, level, pos, orientation, entity);
    }
    ...
    {
        self().m_60734_().setBedOccupied(self(), level, pos, sleeper, occupied);
    }
    ...
    */
    ...
    {
        return self().m_60734_().getBedDirection(self(), level, pos);
    }
    ...
    {
        return self().m_60734_().getExplosionResistance(self(), level, pos, explosion);
    }
    ...
    {
        return self().m_60734_().getCloneItemStack(self(), target, level, pos, player);
    }
    ...
    {
        return self().m_60734_().addLandingEffects(self(), level, pos, state2, entity, numberOfParticles);
    }
   /**
    ...
    */
    ...
    {
        return self().m_60734_().addRunningEffects(self(), level, pos, entity);
    }
    ...
    */
    ...
    {
        return self().m_60734_().canSustainPlant(self(), level, pos, facing, plantable);
    }
    ...
    {
        return self().m_60734_().onTreeGrow(self(), level, placeFunction, randomSource, pos, config);
    }
    ...
    */
    ...
    {
        return self().m_60734_().isFertile(self(), level, pos);
    }
    ...
    {
        return self().m_60734_().isConduitFrame(self(), level, pos, conduit);
    }
    ...
    {
        return self().m_60734_().isPortalFrame(self(), level, pos);
    }
    ...
    */
    ...
    {
        return self().m_60734_().getExpDrop(self(), level, randomSource, pos, fortuneLevel, silkTouchLevel);
    }

    default BlockState rotate(LevelAccessor level, BlockPos pos, Rotation direction)
    {
        return self().m_60734_().rotate(self(), level, pos, direction);
    }
    ...
    */
    ...
    {
        return self().m_60734_().getEnchantPowerBonus(self(), level, pos);
    }
    ...
    */
    ...
    {
        self().m_60734_().onNeighborChange(self(), level, pos, neighbor);
    }
    ...
    */
    ...
    {
        return self().m_60734_().shouldCheckWeakPower(self(), level, pos, side);
    }
    ...
    {
        return self().m_60734_().getWeakChanges(self(), level, pos);
    }
    ...
    {
        return self().m_60734_().getSoundType(self(), level, pos, entity);
    }
    ...
    {
        return self().m_60734_().getBeaconColorMultiplier(self(), level, pos, beacon);
    }
    ...
    {
        return self().m_60734_().getStateAtViewpoint(self(), level, pos, viewpoint);
    }
    ...
    {
        return self().m_60734_().canStickTo(self(), other);
    }
    ...
    {
        return self().m_60734_().getFlammability(self(), level, pos, face);
    }
    ...
    {
        return self().m_60734_().isFlammable(self(), level, pos, face);
    }
    ...
    {
        self().m_60734_().onCaughtFire(self(), level, pos, face, igniter);
    }
    ...
    {
        return self().m_60734_().getFireSpreadSpeed(self(), level, pos, face);
    }
    ...
    {
        return self().m_60734_().isFireSource(self(), level, pos, side);
    }
    ...
    {
        return self().m_60734_().canEntityDestroy(self(), level, pos, entity);
    }
    ...
    {
       return self().m_60734_().isBurning(self(), level, pos);
    }
    ...
    {
        return self().m_60734_().getBlockPathType(self(), level, pos, mob);
    }
    ...
    {
        return self().m_60734_().getAdjacentBlockPathType(self(), level, pos, mob, originalType);
    }
    ...
    {
        return self().m_60734_().canDropFromExplosion(self(), level, pos, explosion);
    }
    ...
    {
        self().m_60734_().onBlockExploded(self(), level, pos, explosion);
    }
    ...
    {
        return self().m_60734_().collisionExtendsVertically(self(), level, pos, collidingEntity);
    }
    ...
    {
        return self().m_60734_().shouldDisplayFluidOverlay(self(), level, pos, fluidState);
    }
    ...
    default BlockState getToolModifiedState(UseOnContext context, ToolAction toolAction, boolean simulate)
    {
        ...
        return eventState != self() ? eventState : self().m_60734_().getToolModifiedState(self(), context, toolAction, simulate);
    }
    ...
    {
        return self().m_60734_().isScaffolding(self(), entity.m_9236_(), entity.m_20183_(), entity);
    }
    ...
    {
        return self().m_60734_().canConnectRedstone(self(), level, pos, direction);
    }
    ...
    {
        return self().m_60734_().hidesNeighborFace(level, pos, self(), neighborState, dir);
    }
    ...
    {
        self().m_60734_().onBlockStateChange(level, pos, oldState, self());
    }
    ...
    {
        return self().m_60734_().canBeHydrated(self(), getter, pos, fluid, fluidPos);
    }
    ...
    {
        return self().m_60734_().getAppearance(self(), level, pos, side, queryState, queryPos);
    }
}
