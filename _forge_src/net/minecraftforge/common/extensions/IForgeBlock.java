...
public interface IForgeBlock
{
    ...
    */
    ...
    {
        return self().m_7397_(level, pos, state);
    }
    ...
    */
    ...
    {
        if (state.m_60713_(Blocks.f_50685_)) return BlockPathTypes.DANGER_OTHER;
        else if (WalkNodeEvaluator.m_77622_(state)) return BlockPathTypes.DANGER_FIRE;
        else return null;
    }
