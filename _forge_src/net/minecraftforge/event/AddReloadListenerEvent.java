...
public class AddReloadListenerEvent extends Event {
    ...
    */
    ...
    private static class WrappedStateAwareListener implements PreparableReloadListener {
        ...
        @Override
        public CompletableFuture<Void> m_5540_(final PreparationBarrier stage, final ResourceManager resourceManager, final ProfilerFiller preparationsProfiler, final ProfilerFiller reloadProfiler, final Executor backgroundExecutor, final Executor gameExecutor) {
            if (ModLoader.isLoadingStateValid())
                return wrapped.m_5540_(stage, resourceManager, preparationsProfiler, reloadProfiler, backgroundExecutor, gameExecutor);
            else
