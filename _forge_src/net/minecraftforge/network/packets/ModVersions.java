...
public record ModVersions(Map<String, Info> mods) {
    ...
    public static ModVersions decode(FriendlyByteBuf buf) {
        return new ModVersions(buf.m_236847_(
            o -> o.m_130136_(MAX_LENGTH),
            o -> new Info(
                o.m_130136_(MAX_LENGTH),
                o.m_130136_(MAX_LENGTH)
            )
        ));
    }
    ...
    public void encode(FriendlyByteBuf output) {
        output.m_236831_(mods,
            (o, s) -> o.m_130072_(s, MAX_LENGTH),
            (o, p) -> {
                o.m_130072_(p.name(), MAX_LENGTH);
                o.m_130072_(p.version(), MAX_LENGTH);
            }
        );
    }
